...
entity NI5764Top is
  port (
    ...
    dtAdcChan0SampleN4              : out std_logic_vector(15 downto 0);
    dtAdcChan0SampleN5              : out std_logic_vector(15 downto 0);
    dtAdcChan0SampleN6              : out std_logic_vector(15 downto 0);
    dtAdcChan0SampleN7              : out std_logic_vector(15 downto 0);
    ...
    dtAdcChan1SampleN4              : out std_logic_vector(15 downto 0);
    dtAdcChan1SampleN5              : out std_logic_vector(15 downto 0);
    dtAdcChan1SampleN6              : out std_logic_vector(15 downto 0);
    dtAdcChan1SampleN7              : out std_logic_vector(15 downto 0);
    ...
    dtAdcChan2SampleN4              : out std_logic_vector(15 downto 0);
    dtAdcChan2SampleN5              : out std_logic_vector(15 downto 0);
    dtAdcChan2SampleN6              : out std_logic_vector(15 downto 0);
    dtAdcChan2SampleN7              : out std_logic_vector(15 downto 0);
    ...
    dtAdcChan3SampleN4              : out std_logic_vector(15 downto 0);
    dtAdcChan3SampleN5              : out std_logic_vector(15 downto 0);
    dtAdcChan3SampleN6              : out std_logic_vector(15 downto 0);
    dtAdcChan3SampleN7              : out std_logic_vector(15 downto 0);

    dtAdcDataValid                  : out std_logic
  );
end entity NI5764Top;

architecture rtl of NI5764Top is

  --vhook_sigstart
  signal aAdcRx: std_logic_vector(7 downto 0);
  signal aAdcRx_n: std_logic_vector(7 downto 0);
  signal aDacTx: std_logic_vector(7 downto 0);
  signal aDacTx_n: std_logic_vector(7 downto 0);
  signal DataClkToLvLcl: std_logic;
  signal GtRefClk: std_logic;
  signal GtRefClkLcl: std_ulogic;
  --vhook_sigend

  --vhook_d NI5764FixedLogic
  component NI5764FixedLogic
    port (
      aConfigTxClkLvds                : out std_logic;
      aConfigTxClkSe                  : out std_logic;
      aConfigTxDataSe                 : out std_logic_vector(6 downto 0);
      ...
      dtAdcChan3SampleN7              : out std_logic_vector(15 downto 0);
      dtAdcDataValid                  : out std_logic;
      dtRxPolarity                    : in  std_logic_vector(7 downto 0));
  end component;
...
begin
  ...
  MapLanes: for i in 0 to kAdcLaneCount-1 generate
    aAdcRx(i) <= MgtPortRx_p(i);
    aAdcRx_n(i) <= MgtPortRx_n(i);
    MgtPortTx_p(i) <= aDacTx(i);
    MgtPortTx_n(i) <= aDacTx_n(i);
  end generate;
  ...
  --vhook_i NI5764FixedLogic
  --vhook_a dtRxPolarity kJessieRxPolarity
  --vhook_a DataClkToLV DataClkToLvLcl
  NI5764FixedLogicx: NI5764FixedLogic
    port map (
      ...
      aAdcRx                          => aAdcRx,                           --in  std_logic_vector(7:0)
      aAdcRx_n                        => aAdcRx_n,                         --in  std_logic_vector(7:0)
      aDacTx                          => aDacTx,                           --out std_logic_vector(7:0)
      aDacTx_n                        => aDacTx_n,                         --out std_logic_vector(7:0)
      ...
      dtAdcChan0SampleN4              => dtAdcChan0SampleN4,               --out std_logic_vector(15:0)
      dtAdcChan0SampleN5              => dtAdcChan0SampleN5,               --out std_logic_vector(15:0)
      dtAdcChan0SampleN6              => dtAdcChan0SampleN6,               --out std_logic_vector(15:0)
      dtAdcChan0SampleN7              => dtAdcChan0SampleN7,               --out std_logic_vector(15:0)
      ...
      dtAdcChan1SampleN4              => dtAdcChan1SampleN4,               --out std_logic_vector(15:0)
      dtAdcChan1SampleN5              => dtAdcChan1SampleN5,               --out std_logic_vector(15:0)
      dtAdcChan1SampleN6              => dtAdcChan1SampleN6,               --out std_logic_vector(15:0)
      dtAdcChan1SampleN7              => dtAdcChan1SampleN7,               --out std_logic_vector(15:0)
      ...
      dtAdcChan2SampleN4              => dtAdcChan2SampleN4,               --out std_logic_vector(15:0)
      dtAdcChan2SampleN5              => dtAdcChan2SampleN5,               --out std_logic_vector(15:0)
      dtAdcChan2SampleN6              => dtAdcChan2SampleN6,               --out std_logic_vector(15:0)
      dtAdcChan2SampleN7              => dtAdcChan2SampleN7,               --out std_logic_vector(15:0)
      ...
      dtAdcChan3SampleN4              => dtAdcChan3SampleN4,               --out std_logic_vector(15:0)
      dtAdcChan3SampleN5              => dtAdcChan3SampleN5,               --out std_logic_vector(15:0)
      dtAdcChan3SampleN6              => dtAdcChan3SampleN6,               --out std_logic_vector(15:0)
      dtAdcChan3SampleN7              => dtAdcChan3SampleN7,               --out std_logic_vector(15:0)
      dtAdcDataValid                  => dtAdcDataValid,                   --out std_logic
      dtRxPolarity                    => kJessieRxPolarity);               --in  std_logic_vector(7:0)
