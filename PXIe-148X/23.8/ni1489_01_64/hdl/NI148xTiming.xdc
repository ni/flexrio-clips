...
###################################################################################
set NI148xClipTop0 [current_instance .]
current_instance %ClipInstancePath%/Mipi4RxTopx
## Start add from file Mipi4RxTop64_mod.xdc
set NiMipiCsi2Inst [current_instance .]

####################################################################################
# Generated by Vivado 2019.1.1 built on 'Sat Jun 29 08:04:45 MDT 2019' by 'xbuild'
# Command Used: write_xdc -force -exclude_physical /azp/agent/_work/11/s/hw-flexrio/iomodules/automotive_vision/clip/objects/tool/synth_mipicsi2ip/Mipi4RxTop64/outputs/Mipi4RxTop64.xdc
####################################################################################
...
current_instance Mipi4Rxx/MipiSharedLogicBankA/SharedLogicMmcmx/inst
...
current_instance Mipi4Rxx/MipiSharedLogicBankB/SharedLogicMmcmx/inst
set_false_path -from [get_pins -leaf -of_objects [get_cells -hier *ram_clk_config* -filter is_sequential] -filter NAME=~*/C] -to [get_pins -leaf -of_objects [get_cells -hier *ram* -filter is_sequential] -filter NAME=~*/D]

####################################################################################
# Constraints from file : 'mipi_dphy_rx_0.xdc'
####################################################################################

current_instance -quiet
current_instance $NiMipiCsi2Inst
current_instance Mipi4Rxx/MipiRxChan0x/mipi_dphy_rx_0x/inst
set_false_path -to [get_pins -hier *cdc_to*/D]

####################################################################################
# Constraints from file : 'mipi_dphy_rx_0_hssio_rx.xdc'
####################################################################################

current_instance -quiet
current_instance $NiMipiCsi2Inst
current_instance Mipi4Rxx/MipiRxChan0x/mipi_dphy_rx_0x/inst/inst/slave_rx.mipi_dphy_rx_0_rx_hssio_i/inst
set_false_path -to [get_pins -hier *sync_flop_0*/D]
current_instance -quiet
current_instance $NiMipiCsi2Inst
create_clock -period 1.333 [get_ports {xRxChan0PinsFlat[8]}]

####################################################################################
# Constraints from file : 'mipi_dphy_rx_2.xdc'
####################################################################################

current_instance Mipi4Rxx/MipiRxChan2x/mipi_dphy_rx_2x/inst
set_false_path -to [get_pins -hier *cdc_to*/D]
...
current_instance -quiet
current_instance $NiMipiCsi2Inst
current_instance Mipi4Rxx/MipiRxChan2x/mipi_dphy_rx_2x/inst/inst/slave_rx.mipi_dphy_rx_2_rx_hssio_i/inst
set_false_path -to [get_pins -hier *sync_flop_0*/D]
current_instance -quiet
current_instance $NiMipiCsi2Inst
...
####################################################################################
# Constraints from file : 'mipi_dphy_rx_4.xdc'
####################################################################################

current_instance Mipi4Rxx/MipiRxChan4x/mipi_dphy_rx_4x/inst
set_false_path -to [get_pins -hier *cdc_to*/D]

####################################################################################
# Constraints from file : 'mipi_dphy_rx_4_hssio_rx.xdc'
####################################################################################

current_instance -quiet
current_instance $NiMipiCsi2Inst
current_instance Mipi4Rxx/MipiRxChan4x/mipi_dphy_rx_4x/inst/inst/slave_rx.mipi_dphy_rx_4_rx_hssio_i/inst
set_false_path -to [get_pins -hier *sync_flop_0*/D]
current_instance -quiet
current_instance $NiMipiCsi2Inst
create_clock -period 1.333 [get_ports {xRxChan4PinsFlat[8]}]

####################################################################################
# Constraints from file : 'mipi_dphy_rx_6.xdc'
####################################################################################

current_instance Mipi4Rxx/MipiRxChan6x/mipi_dphy_rx_6x/inst
set_false_path -to [get_pins -hier *cdc_to*/D]
...
current_instance -quiet
current_instance $NiMipiCsi2Inst
current_instance Mipi4Rxx/MipiRxChan6x/mipi_dphy_rx_6x/inst/inst/slave_rx.mipi_dphy_rx_6_rx_hssio_i/inst
set_false_path -to [get_pins -hier *sync_flop_0*/D]
current_instance -quiet
current_instance $NiMipiCsi2Inst
...
####################################################################################
# Constraints from file : 'Mipi4RxTop64.xdc'
####################################################################################
...
set_max_delay -datapath_only -from [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/BlkIn.iStoredDatax/*/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*oDataFlopx/*/* -filter IS_SEQUENTIAL==true] 9.500
set_false_path -from [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*iPushTogglex/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*oPushToggle0_msx/* -filter IS_SEQUENTIAL==true]
set_max_delay -datapath_only -from [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*oPushToggle0_msx/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*oPushToggle1x/* -filter IS_SEQUENTIAL==true] 2.500
set_false_path -from [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*oPushToggleToReadyx/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*iRdyPushToggle_msx/* -filter IS_SEQUENTIAL==true]
set_max_delay -datapath_only -from [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*iRdyPushToggle_msx/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/SyncPacketGenx/HandshakeSLV_RSDx/HBx/*iRdyPushTogglex/* -filter IS_SEQUENTIAL==true] 6.250
...
set_false_path -to [get_pins -filter REF_PIN_NAME==PRE -of_objects [get_cells Mipi4Rxx/MipiRxChan*/PpiToAxiStreamx/RsdResetGenx/*/Gen1.FDPEx]]
set_false_path -to [get_pins -filter REF_PIN_NAME==PRE -of_objects [get_cells Mipi4Rxx/MipiRxChan*/RsdResetGenx/*/Gen1.FDPEx]]
set_false_path -from [get_cells Mipi4Rxx/MipiRxChan*/PpiToAxiStreamx/RsdResetGenx/acReset_reg*] -through [get_cells Mipi4Rxx/MipiRxChan*/PpiToAxiStreamx/FifoRxByteClkHSToVideoClk/Fifox/FifoFlagsx]
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/PpiToAxiStreamx/FifoRxByteClkHSToVideoClk/Fifox/FifoFlagsx/BlkAddr.SyncToIClkx/cAddrAGrayx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/PpiToAxiStreamx/FifoRxByteClkHSToVideoClk/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] 2.500
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/PpiToAxiStreamx/FifoRxByteClkHSToVideoClk/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/PpiToAxiStreamx/FifoRxByteClkHSToVideoClk/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGrayx/.*/.*} -filter IS_SEQUENTIAL==true] 1.250
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToIClkx/cAddrAGrayx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] 2.500
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGrayx/.*/.*} -filter IS_SEQUENTIAL==true] 1.250
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrAGrayx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToIClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] 5.000
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToIClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/FifoPacketGen/Fifox/FifoFlagsx/BlkAddr.SyncToIClkx/cAddrBGrayx/.*/.*} -filter IS_SEQUENTIAL==true] 2.500
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/DATAPATH_64b.FifoFastToSlowClk/Fifox/FifoFlagsx/BlkAddr.SyncToIClkx/cAddrAGrayx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/DATAPATH_64b.FifoFastToSlowClk/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] 5.000
set_max_delay -datapath_only -from [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/DATAPATH_64b.FifoFastToSlowClk/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGray_msx/.*/.*} -filter IS_SEQUENTIAL==true] -to [get_cells -hier -regexp {.*Mipi4Rxx/MipiRxChan\dx/DATAPATH_64b.FifoFastToSlowClk/Fifox/FifoFlagsx/BlkAddr.SyncToOClkx/cAddrBGrayx/.*/.*} -filter IS_SEQUENTIAL==true] 2.500
set_max_delay -datapath_only -from [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/BlkIn.iStoredDatax/*/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*oDataFlopx/*/* -filter IS_SEQUENTIAL==true] 10.164
set_false_path -from [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*iPushTogglex/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*oPushToggle0_msx/* -filter IS_SEQUENTIAL==true]
set_max_delay -datapath_only -from [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*oPushToggle0_msx/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*oPushToggle1x/* -filter IS_SEQUENTIAL==true] 2.666
set_false_path -from [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*oPushToggleToReadyx/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*iRdyPushToggle_msx/* -filter IS_SEQUENTIAL==true]
set_max_delay -datapath_only -from [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*iRdyPushToggle_msx/* -filter IS_SEQUENTIAL==true] -to [get_cells Mipi4Rxx/MipiRxChan*/ActiveLaneCountHandshake/HBx/*iRdyPushTogglex/* -filter IS_SEQUENTIAL==true] 6.250
...
create_clock           -name DphyCh0Clk                  -period 0.8 [get_ports {aDiffGpio11_p}]
create_clock           -name DphyCh1Clk                  -period 0.8 [get_ports {aDiffGpio14_p}]
...
create_clock           -name DphyCh4Clk                  -period 0.8 [get_ports {aDiffGpio24_p}]
create_clock           -name DphyCh5Clk                  -period 0.8 [get_ports {aDiffGpio43_p}]
