...
begin
  Ch1Gpio: process(sDiagramDes0Gp0Oe, sDiagramDes0Gp5Out, sDiagramDes0Gp2Out, sDiagramDes0Gp4Oe, sDiagramDes0Gp0Out,
    sDiagramDes0Gp6Out, sDiagramDes0Gp1Oe, sDiagramDes0Gp6Oe, sDiagramDes0Gp5Oe, sDiagramDes0Gp2Oe, sDiagramDes0Gp4Out,
    sDiagramCh1GpIn, sDiagramDes0Gp3Out, sDiagramDes0Gp1Out, sDiagramDes0Gp3Oe) is
  begin
  ...
  Ch3Gpio: process(sDiagramDes1Gp0Out, sDiagramDes1Gp6Oe, sDiagramDes1Gp0Oe, sDiagramDes1Gp3Out, sDiagramDes1Gp5Oe,
    sDiagramDes1Gp4Out, sDiagramDes1Gp6Out, sDiagramDes1Gp4Oe, sDiagramDes1Gp2Out, sDiagramDes1Gp5Out, sDiagramDes1Gp3Oe,
    sDiagramDes1Gp1Out, sDiagramCh3GpIn, sDiagramDes1Gp1Oe, sDiagramDes1Gp2Oe) is
  begin
  ...
  Ch5Gpio: process(sDiagramDes2Gp1Out, sDiagramDes2Gp1Oe, sDiagramDes2Gp4Oe, sDiagramCh5GpIn, sDiagramDes2Gp5Out,
    sDiagramDes2Gp5Oe, sDiagramDes2Gp6Oe, sDiagramDes2Gp3Out, sDiagramDes2Gp4Out, sDiagramDes2Gp2Oe, sDiagramDes2Gp6Out,
    sDiagramDes2Gp0Out, sDiagramDes2Gp2Out, sDiagramDes2Gp0Oe, sDiagramDes2Gp3Oe) is
  begin
  ...
  Ch7Gpio: process(sDiagramDes3Gp1Out, sDiagramDes3Gp6Oe, sDiagramDes3Gp2Out, sDiagramDes3Gp1Oe, sDiagramDes3Gp4Oe,
    sDiagramDes3Gp3Oe, sDiagramDes3Gp6Out, sDiagramCh7GpIn, sDiagramDes3Gp4Out, sDiagramDes3Gp5Oe, sDiagramDes3Gp0Out,
    sDiagramDes3Gp2Oe, sDiagramDes3Gp3Out, sDiagramDes3Gp5Out, sDiagramDes3Gp0Oe) is
  begin
  ...
  Ch0Gpio: process(sDiagramSer0Gp3Out, sDiagramSer0Gp2Oe, sDiagramSer0Gp0Out, sDiagramSer0Gp2Out, sDiagramSer0Gp0Oe,
    sDiagramSer0Gp3Oe, sDiagramSer0Gp1Out, sDiagramSer0Gp1Oe, sDiagramCh0GpIn) is
  begin
  ...
  Ch2Gpio: process(sDiagramSer1Gp3Oe, sDiagramSer1Gp0Oe, sDiagramSer1Gp1Oe, sDiagramSer1Gp0Out, sDiagramSer1Gp2Oe,
    sDiagramSer1Gp3Out, sDiagramSer1Gp1Out, sDiagramSer1Gp2Out, sDiagramCh2GpIn) is
  begin
  ...
  Ch4Gpio: process(sDiagramSer2Gp2Oe, sDiagramSer2Gp3Out, sDiagramSer2Gp1Out, sDiagramSer2Gp3Oe, sDiagramSer2Gp0Oe,
    sDiagramSer2Gp2Out, sDiagramSer2Gp0Out, sDiagramSer2Gp1Oe, sDiagramCh4GpIn) is
  begin
  ...
  Ch6Gpio: process(sDiagramSer3Gp2Out, sDiagramSer3Gp3Oe, sDiagramSer3Gp1Out, sDiagramSer3Gp3Out, sDiagramSer3Gp1Oe,
    sDiagramSer3Gp2Oe, sDiagramSer3Gp0Out, sDiagramSer3Gp0Oe, sDiagramCh6GpIn) is
  begin
  ...
  begin
    ...
    sDiagramDes0Lock  <= sDiagramMiscGpIn(7);
    sDiagramMiscGpOe(7)  <= '0';
    sDiagramDes0Pass  <= sDiagramMiscGpIn(3);
    sDiagramMiscGpOe(3)  <= '0';
    sDiagramDes1Lock  <= sDiagramMiscGpIn(5);
    sDiagramMiscGpOe(5)  <= '0';
    sDiagramDes1Pass  <= sDiagramMiscGpIn(4);
    sDiagramMiscGpOe(4)  <= '0';
    sDiagramDes2Lock  <= sDiagramMiscGpIn(15);
    sDiagramMiscGpOe(15)  <= '0';
    sDiagramDes2Pass  <= sDiagramMiscGpIn(11);
    sDiagramMiscGpOe(11)  <= '0';
    sDiagramDes3Lock  <= sDiagramMiscGpIn(13);
    sDiagramMiscGpOe(13)  <= '0';
    sDiagramDes3Pass  <= sDiagramMiscGpIn(12);
