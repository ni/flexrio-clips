-------------------------------------------------------------------------------
--
-- File: PkgAXI4Lite_GTHE3_Control.vhd
-- Author: Brandon Griffith
-- Original Project: UltraScale Research
-- Date: April 2015
--
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
--
-- Purpose: This package is used by the AXI4Lite_GTHE3_Control_Regs component.
--
-------------------------------------------------------------------------------
...
package PkgAXI4Lite_GTHE3_Control is

  -- Arrays of std_logic_vector for indexing into separate GTH transceivers.
  ...
  subtype GTHCursorSel_t is std_logic_vector(4 downto 0);
  type GTHCursorSelAry_t is array(natural range <>) of GTHCursorSel_t;

  subtype GTHDiffCtrl_t is std_logic_vector(3 downto 0);
  type GTHDiffCtrlAry_t is array(natural range <>) of GTHDiffCtrl_t;

  subtype GTHDMonitorOut_t is std_logic_vector(16 downto 0);
  type GTHDMonitorOutAry_t is array(natural range <>) of GTHDMonitorOut_t;
...
end package PkgAXI4Lite_GTHE3_Control;

package body PkgAXI4Lite_GTHE3_Control is
