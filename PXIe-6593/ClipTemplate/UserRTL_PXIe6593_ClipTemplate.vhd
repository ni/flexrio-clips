-------------------------------------------------------------------------------
--
-- File: UserRTL_PXIe6593_ClipTemplate.vhd
...
--
-- Purpose:
--   This template is intended to be used as an example to create a custom 6593
-- I/O module CLIP. It includes the logic that is required for the 6593 to operate.
...
--
-- The required diagram signals are status signals that are common to any 6593
-- CLIP. These are exposed in the LabVIEW FPGA diagram and should be connected
-- to an indicator for use by the driver. See the 6593 LabVIEW examples for
...
-------------------------------------------------------------------------------
--
-- vreview_group Ni6593TemplateClipVhdl
-- vreview_closed http://review-board.natinst.com/r/315306/
...
entity UserRTL_PXIe6593_ClipTemplate is
  port (
    ------------------------------
    -- Reset                    --
    ------------------------------
...
end UserRTL_PXIe6593_ClipTemplate;

architecture rtl of UserRTL_PXIe6593_ClipTemplate is
...
begin
  ...
  -----------------------------------------------------------------------------
  -- Instantiate IBUFDS_GTE3 buffers on the reference clock pins.
  ...
  IbufdsGen: for i in MgtRefClk_p'range generate
    ...
    --vhook_i IBUFDS_GTE3 IBUFDS_GTE3x
    --vhook_gh {.*}
