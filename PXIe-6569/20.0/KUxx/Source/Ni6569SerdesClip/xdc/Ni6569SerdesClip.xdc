...
create_clock -name RxClkExt  -period 1.6 [get_ports {aDiffGpio_p[53]}]
...
set_property CLOCK_DELAY_GROUP OSERDES [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClockDiv/O]]
set_property CLOCK_DELAY_GROUP OSERDES [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClock/O]]

set_property CLOCK_DELAY_GROUP ISERDES [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClock/O]]
set_property CLOCK_DELAY_GROUP ISERDES [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClockDiv/O]]

set_property USER_CLOCK_ROOT [get_clock_regions -of [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/GenerationEnginex/DataSer/SerialGen[31].OSerdes]] [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClockDiv/O]]
set_property USER_CLOCK_ROOT [get_clock_regions -of [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/GenerationEnginex/DataSer/SerialGen[31].OSerdes]] [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClock/O]]

set_property USER_CLOCK_ROOT [get_clock_regions -of [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/AcquisitionEnginex/DataDeser/DataIoDelayGen[0].ISerdes]] [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClockDiv/O]]
set_property USER_CLOCK_ROOT [get_clock_regions -of [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/AcquisitionEnginex/DataDeser/DataIoDelayGen[0].ISerdes]] [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClock/O]]
set_property USER_CLOCK_ROOT [get_clock_regions -of [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/AcquisitionEnginex/DataDeser/DataIoDelayGen[0].ISerdes]] [get_nets -of [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/RxDataClkMux/O]]

set_property CLOCK_REGION [get_clock_regions -of [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/GenerationEnginex/DataSer/SerialGen[31].OSerdes]] [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClock]
set_property CLOCK_REGION [get_clock_regions -of [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/GenerationEnginex/DataSer/SerialGen[31].OSerdes]] [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClockDiv]

#During several compilations after added RSD, Vivado would place DataClockRx buffer to X2Y4, whereas ISerdesClock and ISerdesClockDiv buffers to X0Y4.
#This causes timing harder to meet especially on DataClockRx, due to the bGateClock that eventually drives the rmRxBufClr is located at X0Y1.
#Hence, I'd put set clock_region constraints on DataClockRx, ISerdesClock and ISerdesClockDiv buffers to X0Y3, so that it is easier to meet the timing.
set_property CLOCK_REGION [get_clock_regions -of [get_cells dr0DramTestMode_OBUF_inst]] [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClockDiv]
set_property CLOCK_REGION [get_clock_regions -of [get_cells dr0DramTestMode_OBUF_inst]] [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClock]
set_property CLOCK_REGION [get_clock_regions -of [get_cells dr0DramTestMode_OBUF_inst]] [get_cells %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/DataClockRx]
...
set_clock_groups -logically_exclusive -group [get_clocks -include_generated_clock RxClkExt] -group [get_clocks -include_generated_clock LmkClk]
set_clock_groups -logically_exclusive -group [get_clocks -include_generated_clock RxClkExt] -group [get_clocks -include_generated_clock SiClk]

#From bRxClkInSelection to RxDataClkMux's Selectors
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/bRxClkInSelection*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/RxDataClkMux/S*] 10.0

#From MMCM locked signal through FilterStdLogic to RxDataClkMux's Selectors
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/MmcmLockCycleFilter/cOSigLcl*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/RxDataClkMux/S*] 10.0

########### To close I/ODELAY related timing ###########
# Asynchronous reset signal for DataIDelayCtrl
set_false_path \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/FixedLogicSerdesCommonx/ConfigGpiox/bResetDelayCtrlLcl*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/DataIDelayCtrl*/RST]
...
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/bGateClock*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/DataClockTx/CLR] 10
...
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/bGateClock*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/DataClockCopyTx/CLR] 10
...
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsTxBufgceClrLcl*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClockDiv/CLR] 4.8
...
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsTxBufgceClrLcl*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClock/CLR] 4.8
...
set_max_delay -datapath_only \
  ...
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/ClkOutInversionDS/DoubleSyncAsyncInBasex/oSig_msx/Gen*.FDCEx/D] 10.0
...
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/RxBufEnableRSD/acReset*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/DataClockRx/CLR] 4.8

set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/RxBufEnableRSD/acReset*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClock/CLR] 4.8

set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/RxBufEnableRSD/acReset*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/ISerdesClockDiv/CLR] 4.8
...
set_max_delay -datapath_only \
  ...
  -to [get_pins {%ClipInstancePath%/Ni6569SerdesClipFlx/PinsMappingx/SeDirectionControl*.SeDataDirCtrl/rgOutputEn_ms*/D}] 10.0
...
### set_max_delay \
###   -from [get_pins {%ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/TxDataClkCopyCounterSample/HBx/BlkOut.ODataFlop/GenFlops*.DFlopx/Gen*.FDCEx/C}] \
...
### set_max_delay \
###   -from [get_pins {%ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClkDivCounterSample/HBx/BlkOut.ODataFlop/GenFlops*.DFlopx/Gen*.FDCEx/C}] \
...
### set_max_delay -datapath_only \
###   -from [get_pins {%ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsBufResetVec*/C}] \
###   -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/TxDataClkCopyCounterSample/HBx/*/*/*/CLR] 10.0
###
### set_max_delay -datapath_only \
###   -from [get_pins {%ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsBufResetVec*/C}] \
###   -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/TxDataClkCopyCounterSample/HBx/*/*/CLR] 10.0
...
### set_max_delay -datapath_only \
###   -from [get_pins {%ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsBufResetVec*/C}] \
###   -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClkDivCounterSample/HBx/*/*/*/CLR] 10.0
###
### set_max_delay -datapath_only \
###   -from [get_pins {%ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsBufResetVec*/C}] \
###   -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClkDivCounterSample/HBx/*/*/CLR] 10.0
...
### set_max_delay -datapath_only \
###   -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsBufResetVec*/C] \
###   -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/OSerdesClkDivCounterSample/HBx/BlkRdy.iReset*/Gen*.FDPEx/PRE] 10.0
###
### set_max_delay -datapath_only \
###   -from [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/tsBufResetVec*/C] \
###   -to [get_pins %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex/TxDataClkCopyCounterSample/HBx/BlkRdy.iReset*/Gen*.FDPEx/PRE] 10.0
###
### set OriBasePath %ClipInstancePath%/Ni6569SerdesClipFlx/TimingEnginex
###
### #########################
...
set OriBasePath %ClipInstancePath%/Ni6569SerdesClipFlx
...
set OriBasePath %ClipInstancePath%/Ni6569SerdesClipFlx/GenerationEnginex/DataSer
...
set OriBasePath %ClipInstancePath%/Ni6569SerdesClipFlx/AcquisitionEnginex/DataDeser
...
set OriBasePath %ClipInstancePath%/Ni6569SerdesClipFlx/AcquisitionEnginex/BitSlipGen*.SimpleBitSlipx
