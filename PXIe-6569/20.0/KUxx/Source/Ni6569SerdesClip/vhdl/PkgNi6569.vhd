...
package PkgNi6569 is
  ...
  -- Total of kNumRxSSCLK and kNumRxDataChannel should meet 32 in HIHO variant.
  constant kNumRxSSClk : positive := 1;
  constant kNumRxDataChannel : positive := 31;

  constant kNumTxDataChannel : positive := 32;
  ...
  -- therefore DeserArray_t and SerArray_t have widths of 8.
