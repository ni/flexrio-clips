...
create_clock -name RxClkExt  -period 6.667 [get_ports {aDiffGpio_p[53]}]
...
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569BasicClipFlx/TimingEngineBasicx/bRxClkInSelection*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569BasicClipFlx/TimingEngineBasicx/RxDataClkMux/S*] 10.0

########### To close I/ODELAY related timing ###########
# Asynchronous reset signal for DataIDelayCtrl
set_false_path \
  -from [get_pins %ClipInstancePath%/Ni6569BasicClipFlx/FixedLogicBasicCommonx/ConfigGpiox/bResetDelayCtrlLcl*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569BasicClipFlx/DataIDelayCtrl*/RST]

########### For TX MUX Selector ###########
#From bTxClkInSelection to TxDataClkMux's Selectors
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569BasicClipFlx/TimingEngineBasicx/bTxClkInSelection*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569BasicClipFlx/TimingEngineBasicx/TxDataClkMux/S*] 10.0
...
set_max_delay -datapath_only \
  ...
  -to [get_pins {%ClipInstancePath%/Ni6569BasicClipFlx/PinsMappingx/SeDirectionControl*.SeDataDirCtrl/rgOutputEn_ms*/D}] 5.0
...
set OriBasePath %ClipInstancePath%/Ni6569BasicClipFlx
...
set OriBasePath %ClipInstancePath%/Ni6569BasicClipFlx/ODelayBasicx
...
set OriBasePath %ClipInstancePath%/Ni6569BasicClipFlx/IDelayBasicx
...
set OriBasePath %ClipInstancePath%/Ni6569BasicClipFlx/TimingEngineBasicx
