...
create_clock -name RxClkExt  -period 6.667 [get_ports {aDiffGpio_p[15]}]
...
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569BasicClipAllInFlx/TimingEngineBasicAllInx/bRxClkInSelection*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569BasicClipAllInFlx/TimingEngineBasicAllInx/RxDataClkMux/S*] 10.0

########### To close I/ODELAY related timing ###########
# Asynchronous reset signal for DataIDelayCtrl
set_false_path \
  -from [get_pins %ClipInstancePath%/Ni6569BasicClipAllInFlx/FixedLogicBasicCommonx/ConfigGpiox/bResetDelayCtrlLcl*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569BasicClipAllInFlx/DataIDelayCtrl*/RST]

########### For TX MUX Selector ###########
#From bTxClkInSelection to TxDataClkMux's Selectors
set_max_delay -datapath_only \
  -from [get_pins %ClipInstancePath%/Ni6569BasicClipAllInFlx/TimingEngineBasicAllInx/bTxClkInSelection*/C] \
  -to [get_pins %ClipInstancePath%/Ni6569BasicClipAllInFlx/TimingEngineBasicAllInx/TxDataClkMux/S*] 10.0
...
set_max_delay -datapath_only \
  ...
  -to [get_pins {%ClipInstancePath%/Ni6569BasicClipAllInFlx/PinsMappingAllInx/SeDirectionControl*.SeDataDirCtrl/rgOutputEn_ms*/D}] 5.0
...
set OriBasePath %ClipInstancePath%/Ni6569BasicClipAllInFlx

################################
## ResetSyncDeassert Constraints
################################

set BasePath $OriBasePath/DiagramResetRSD
...
set OriBasePath %ClipInstancePath%/Ni6569BasicClipAllInFlx/IDelayBasicx
...
set OriBasePath %ClipInstancePath%/Ni6569BasicClipAllInFlx/TimingEngineBasicAllInx

################################
## ResetSyncDeassert Constraints
################################

set BasePath $OriBasePath/RxTxDataClkMuxEnableRSD
...
set BasePath $OriBasePath/RxSsClkMuxEnableRSD
