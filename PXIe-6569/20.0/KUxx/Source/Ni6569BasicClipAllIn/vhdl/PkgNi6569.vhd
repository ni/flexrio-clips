...
package PkgNi6569 is
  ...
  -- Total of kNumRxSSCLK and kNumRxDataChannel should meet 64 in ALL IN Basic variant.
  constant kNumRxSSClk : positive := 1;
  constant kNumRxDataChannel : positive := 63;
  ...
  -- therefore DeserArray_t have widths of 8.
