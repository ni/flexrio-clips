-------------------------------------------------------------------------------
--
-- File: UserRTL_PXIe6594_Aurora64b66b_Streaming.vhd
...
-------------------------------------------------------------------------------
--
-- vreview_group Ni6594AuroraStreamingVhdl
...
entity UserRTL_PXIe6594_Aurora64b66b_Streaming is
  port (
    ------------------------------
    -- Reset                    --
    ------------------------------
    ...
    -------------------------------------------------------------------------------
    -- AXI4 Streaming interfaces - Aurora
    -------------------------------------------------------------------------------
...
end UserRTL_PXIe6594_Aurora64b66b_Streaming;

architecture rtl of UserRTL_PXIe6594_Aurora64b66b_Streaming is
  ...
  --vhook_d aurora_64b66b_DS
  component aurora_64b66b_DS
    port (
  ...
  signal uPort_s_axi_tx_tvalid, uPort_s_axi_tx_tready : std_logic_vector(kNumPorts-1 downto 0);
  signal uPort_m_axi_rx_tvalid : std_logic_vector(kNumPorts-1 downto 0);
...
begin
  ...
  begin
    GenAurora : for i in 0 to kNumPorts-1 generate
      ...
      --vhook aurora_64b66b_DS Aurora_PortN
